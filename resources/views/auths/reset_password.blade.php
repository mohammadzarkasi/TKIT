        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light"> masukkan email yang telah didaftarkan untuk diatur ulang
                passwordnya.</h6>
              <form action="{{ url('/reset-password') }}" method="POST" class="pt-3">
                @csrf
                ...
                <div class="form-group">
                  <label>Kode Reset Password</label>
                  <input name="kode" type="text" class="form-control form-control-lg" id="kode" placeholder="Kode"
                    value="{{ old('kode', $kode ?? '') }}">
                </div>
                ...
                <div class="my-3">
                  <button type="submit" value="Login"
                    class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">Simpan
                    Password</button>
                </div>
                ...
                <div class="text-center font-weight-light">
                  Atau kembali ke <a href="{{ url('/login') }}" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
