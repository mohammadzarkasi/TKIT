        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light"> masukkan email yang telah didaftarkan untuk diatur ulang passwordnya.</h6>
              <form action="{{ url('/forgot-password') }}" method="POST" class="pt-3">
                @csrf
                ...
                <div class="my-3">
                  <button type="submit" value="Login" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">Reset Password</button>
                </div>
