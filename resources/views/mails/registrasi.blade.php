...
<?php
$link_aktivasi = url('/activate-account?email=' . ($email ?? 'xx') . '&token=' . ($token ?? 'xy'));
?>
...
<head>
    ...
    <title>Lengkapi Data Registrasi Anda</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                        ...
                        <tr style="border-collapse:collapse">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src="https://tleonn.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://tleonn.stripocdn.email/content/guids/CABINET_3df254a10a99df5e44cb27b842c2c69e/images/7331519201751184.png"
                                                                        alt
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        button below. --}}
                                                                        Sebelum dapat melanjutkan, Anda perlu melakukan konfirmasi akun. Cukup klik tombol di bawah ini.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Jika tombol tersebut tidak dapat diklik, salin dan buka link berikut di browser:
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                    <a target="_blank" href="{{ $link_aktivasi }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                        Anda menerima email ini karena Anda baru saja mendaftarkan akun baru.
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                        TKIT Buah Hati Kita - Jl. Mastrip Timur 106, Sumbersari, Kec. Sumbersari, Jember, Jawa Timur
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td class="es-infoblock made_with" align="center"
                                                                    ...
                                                                    <a target="_blank"
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"><img
                                                                            src="https://tleonn.stripocdn.email/content/guids/CABINET_9df86e5b6c53dd0319931e2447ed854b/images/64951510234941531.png"
